...
export default function Home() {
  ...
  const clientLogos = [
    ...
    { name: 'GlobalFinance', logo: '/clients/globalfinance.png' },
    { name: 'HealthPlus', logo: '/clients/healthplus.png' },
    { name: 'EduTech', logo: '/clients/edutech.png' },
    { name: 'ManufacturingPro', logo: '/clients/manufacturing.png' },
    { name: 'RetailGiant', logo: '/clients/retail.png' }
  ]
  ...
  const mobileApps = {
    ios: {
      url: 'https://apps.apple.com/app/techsolutions-pro/id123456789',
      qrCode: '/qr/ios-app.png',
      features: ['Project Management', 'Real-time Chat', 'Document Sharing', 'Analytics Dashboard']
    },
    android: {
      url: 'https://play.google.com/store/apps/details?id=com.techsolutions.pro',
        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <button onClick={() => window.location.href = '/blog'} className="text-foreground hover:text-primary transition-colors">Blog</button>
              <button onClick={() => window.location.href = '/careers'} className="text-foreground hover:text-primary transition-colors">Careers</button>
              <button onClick={() => window.location.href = '/pricing'} className="text-foreground hover:text-primary transition-colors">Pricing</button>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
                <VideoPlayer
                  ...
                  title="TechSolutions Pro Introduction"
                  className="w-full"
                />
              </div>
            </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 p-8">
                    ...
                    <div className="flex items-center justify-center bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg">
                      <div className="text-center p-8">
                        <BarChartIcon className="w-16 h-16 mx-auto mb-4 text-blue-600" />
                        <h4 className="text-lg font-semibold mb-2">Project Results</h4>
                        <p className="text-muted-foreground">
                          Measurable impact on business performance and operational efficiency
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Grow your business by partnering with TechSolutions Pro.
            </p>
          </div>
